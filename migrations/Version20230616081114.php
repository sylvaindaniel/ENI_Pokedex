 ...
 */
final class Version20230616081114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pokemon (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, catch_day DATETIME NOT NULL, catch_place VARCHAR(100) DEFAULT NULL, level INT NOT NULL, hp INT NOT NULL, shiny TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
